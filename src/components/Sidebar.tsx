...
const Sidebar = () => {
  ...
  return (
    <>
      {/* Mobile menu button */}
      <button
        className={`md:hidden fixed top-3 left-4 z-50 p-2 bg-white rounded-lg shadow-md transition-opacity duration-300 ${
      ...
      >
        <div className="flex items-center p-5 border-b border-gray-200">
          <img className="w-7 h-7 mr-2" src="public/assets/images/icon.png" />
            ...
            <div>
              ...
              {isDashboardOpen && (
                <div className="ml-8 space-y-1 mt-1">
                  ...
                  <a
                    href="#"
                    className="block p-2 rounded-lg bg-gray-900 text-white"
                  >
                    Sales
                  </a>
                </div>
